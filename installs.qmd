...
[**\***]{style="font-size:200%;"} _Note_: If you have a pre-existing installation of `R` and/or RStudio, I strongly recommend that you reinstall both and get as current as possible. It can often be problematic to run old software.
